...
public final class Enums {
    ...
    public enum RecoveryStatus { PAYMENT_INTERRUPTED, RECOVERY_IN_PROGRESS, RETRY_AVAILABLE, SECURITY_CLEARED_RETRY_REQUIRED, COMPLETED_AFTER_RETRY, COMPLETED_WITH_ALTERNATE_CARD, ACTION_REQUIRED }
}
