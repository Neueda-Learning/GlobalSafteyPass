  ...
  try{
    ...
    openSheet(`<button class="back" onclick="activate('trips')">← All journeys</button>
      ...
      <div class="detail-grid">
        ...
        <div><small>REMAINING</small><strong>${money(d.remaining)}</strong></div>
